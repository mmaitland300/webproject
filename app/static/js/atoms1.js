...
function preload ()
{
    this.load.scenePlugin('Camera3DPlugin', 'static/js/camera3d.min.js', 'Camera3DPlugin', 'cameras3d');

    this.load.image('ball', 'static/assets/aqua_ball.png');
    this.load.image('ball2', 'static/assets/yellow_ball.png');
}
