...
Phase 2 added the blog you're reading. Phases 3 and 4 will bring:

- A database-backed admin inbox for contact submissions
- OAuth authentication with Auth.js
- Command palette navigation
- Dark/light mode toggle
- Lighthouse optimization pass

Stay tuned for more posts as I build out each phase.
