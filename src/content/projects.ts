  ...
  },
  {
    ...
    proofLinks: [
      ...
      },
      {
        ...
        href: "https://github.com/mmaitland300/maitland-portfolio/blob/main/e2e/routes.spec.ts",
        kind: "test",
      },
      {
        label: "Environment parsing tests",
        href: "https://github.com/mmaitland300/maitland-portfolio/blob/main/src/lib/env.test.ts",
        kind: "test",
      },
      {
        label: "Contact action tests",
        href: "https://github.com/mmaitland300/maitland-portfolio/blob/main/src/actions/contact.test.ts",
        kind: "test",
      },
      {
        label: "CI workflow",
        href: "https://github.com/mmaitland300/maitland-portfolio/blob/main/.github/workflows/ci.yml",
        kind: "ci",
      },
    ],
    tags: [
    ...
    github: "https://github.com/mmaitland300/maitland-portfolio",
