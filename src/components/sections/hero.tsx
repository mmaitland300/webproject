  ...
  return (
    <section className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden">
      <div className="cyber-frame mx-auto max-w-6xl px-6 py-32 text-center">
        ...
        >
          I support Full Swing simulator systems at Auxillium — remote troubleshooting
          across hardware, software, and networking layers. Outside of that, I build web
          applications and an audio plugin called StringFlux. This site documents what
